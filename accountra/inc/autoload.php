...
/**
 * Autoloader function for Accountra theme classes
 *
 * @param string $class The fully-qualified class name.
 * @return void
 */
function accountra_autoloader( $class ) {
    $prefix   = 'Accountra';
    $base_dir = ACCOUNTRA_DIR . 'inc/class/';
    $len      = strlen( $prefix );
...
spl_autoload_register( 'accountra_autoloader' );